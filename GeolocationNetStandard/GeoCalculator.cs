...
namespace Geolocation
{
    ...
    public static class GeoCalculator
    {
        ...
        /// </summary>
        public static double GetDistance(double originLatitude, double originLongitude, double destinationLatitude, double destinationLongitude, int decimalPlaces = 2, DistanceUnit distanceUnit = DistanceUnit.Miles)
        {
